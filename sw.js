...
const ASSETS = ['./', 'index.html', 'css/main.css', 'manifest.webmanifest', 'favicon.svg', 'icon-192.png',
  ...
  'js/students.js', 'js/picker.js', 'js/behavior.js', 'js/tla.js', 'js/tla-autofill.js', 'js/form-templates.js', 'js/passport.js', 'js/medical.js', 'js/books.js', 'js/reading-assess.js', 'js/certificate.js', 'js/tracking.js', 'js/dashboard.js',
  'js/admin.js', 'js/cashbox.js', 'js/lobby.js', 'js/forms.js', 'js/teacher.js', 'js/tasks.js',
