...
(function () {
  ...
  const seed = {
    ...
    students: [
      { id: 1, name: 'יעקב לדוגמה', class_id: 1, parent_name: 'משה לדוגמה', parent_phone: '050-0000001', status: 'פעיל', notes: 'ילד מתמיד', reg: { 'שם התלמיד':'יעקב','משפחה':'לדוגמה','תעודת זהות':'000000000','תאריך לידה עברי - שנה':'תשפ״א','תאריך לידה עברי - חודש':'ניסן','תאריך לידה עברי - יום':'ט״ו','תאריך לידה לועזי':'01/04/2015','מקום לימודים נוכחי':'ת״ת מנוחה','כיתה':'ג','מספר ילדים בבית':'6','מיקום הילד במשפחה':'3','עיר':'בית שמש','רחוב':'רחוב הרצל','מספר':'12','טלפון בבית':'02-9999999','שם האב':'משה','תעודת זהות אב':'111111111','נייד אב':'050-0000001','אימייל אב':'demo@example.com','ארץ לידה אב':'ישראל','מקום לימודים אב - ישיבה גדולה':'מיר','עיסוק אב':'אברך','שם האם':'שרה','שם משפחה קודם':'כהן','תעודת זהות אם':'222222222','נייד אם':'050-0000002','אימייל אם':'demo2@example.com','ארץ לידה אם':'ישראל','מקום לימודים אם - תיכון וסמינר':'בית יעקב','עיסוק אם':'מורה','שם מנהל':'הרב','שם בית הכנסת בו מתפללים בשבת':'לדרמן','שם הרב של המשפחה':'הרב פלוני','קופת חולים':'מאוחדת','האם הרשימה הבאה חלה על בנכם':'קשב וריכוז','הערות / בקשות / הוספות':'—' } },
