...
(function () {
  ...
  const METHOD_PROMPT = [
    ...
    '6. הצעד המעשי חייב להיות ספציפי ויצירתי — נגזר ישירות מהפרטים הקונקרטיים',
    '   שמופיעים למעלה (שם תלמיד/כיתה, מספר, דפוס מסוים), לא ניסוח כללי שהיה',
    '   מתאים לכל ניתוח. גוון בין הצעות — אל תחזור על אותה המלצה תבניתית.',
    '   **לעולם אל תמליץ לצמצם תיעוד, דיווח או מעקב כדי "לשפר" מדד** — המטרה',
    '   המוסדית היא לתעד כמה שיותר ומדויק יותר, לא פחות. הרבה דיווחים הם עדות',
    '   לתשומת לב טובה של הצוות, לא בעיה שצריך להקטין באמצעות דיווח פחות.',
    '',
