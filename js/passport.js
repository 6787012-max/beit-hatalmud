...
(function () {
  ...
  // תוקן 07/09/2026: היה 29/08 (ט״ז אלול, בפועל שבת כי תבוא) — שבוע שלם קדימה
  // מדי. אומת מול Intl (he-u-ca-hebrew): 22/08/2026 הוא שבת ט׳ אלול תשפ״ו.
  const WEEK1 = new Date(2026, 7, 22);      // 22/08/2026, ט׳ אלול תשפ״ו (שבת כי תצא)
