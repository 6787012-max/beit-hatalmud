...
(function () {
  ...
  const TEMPLATES = {
    ...
    outings: {
      ...
      // נוסח 09/09/2026 (בקשת יוסף): מבוסס על טופס "אישור ההורים בגין יציאת
      // בני מכותלי הת\"ת" של ת\"ת עטרת שלמה רמב\"ש ד' — הפנייה הרשמית להנהלה,
      // סימון בריאותי תלת-מצבי עם \"מצורף אישור רפואי\", וסעיף האחריות המפורש
      // על הורה שלא מעדכן שינוי. הארכיטקטורה (אישור מאוחד אחד, לא טופס נפרד
      // לבריאות מול יציאות) נשארה כפי שיוסף קבע במפורש — רק הניסוח השתנה.
      body: '## לכבוד הנהלת מכינת בית התלמוד\nהריני לאשר את יציאת בני מכותלי המכינה, לפעילויות בתחומי היישוב ולטיולים, סיורים ואירועים על פי התכנית השנתית, בשנת הלימודים התשפ״ז.\n\n## מה כולל האישור\nהאישור כללי לשנת הלימודים כולה, ואינו מצריך אישור נפרד לכל יציאה או פעילות בפני עצמה. הוא כולל:\n• יציאות, סיורים, פעילויות, אירועים וטיולים של המכינה על פי התכנית השנתית, לרבות פעילות הכוללת לינה\n• הסעה מאורגנת ברכב מורשה להסעת תלמידים\n• פנייה לטיפול רפואי דחוף ומתן עזרה ראשונה במקרה חירום, כאשר ההורים ייודעו מיד\n• יציאה עצמאית לצורך אישי בתחומי היישוב, בכפוף לאישור פרטני של הנהלת המכינה בכל פעם\n• צילום בפעילות ופרסום התמונה בפרסומי המכינה\nתכנית הפעילות והטיולים השנתית מצויה במשרד המכינה ופתוחה לעיון ההורים בכל עת, לפי פנייה למזכירות.\n\n## מצב בריאותי\nנא לסמן בשדה שלהלן את המצב המתאים.\nתלמיד שיחול שינוי במצבו הבריאותי במהלך שנת הלימודים תשפ״ז — חובה על ההורים לעדכן על כך מיד ובכתב. הורה שלא יעדכן על שינוי במצב הבריאות, מסיר בזאת את האחריות מצוות המכינה, ולא יוכל לבוא בטענות להנהלת המכינה.\n\n## תוקף\nהטופס תקף לשנת לימודים אחת בלבד — התשפ״ז (2026–2027).',
      fields: [
        F('מצב בריאותי', 'select',
