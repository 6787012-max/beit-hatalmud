...
(function () {
  ...
  function roleCaps(role) {
    ...
    const entry = ['behavior', 'attendance', 'tests', 'passport'];  // מסכי הזנה (מלמד)
    const nonMoney = ['behavior', 'attendance', 'tests', 'readassess', 'tla', 'passport', 'students', 'medical', 'forms', 'calendar', 'reports', 'exporter'];
    switch (role) {
